...
import jpaBook.springJpa01.exception.NotEnoughStockException;
...
@SpringBootTest
@Transactional // TEST 메서드 끝날때마다 Roll-back 처리
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        assertEquals("주문 수량만큼 재고가 마이너스", 8, book.getStockQuantity());
    }
    ...
    public void 상품주문_재고수량추가() throws Exception {
        ...
        Member member = createMember();
        Item book = createBook("시골 JPA", 10000, 10);
        int orderCount = 11; // 오류 발생시킬 재고 수량
